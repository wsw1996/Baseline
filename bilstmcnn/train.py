...
writer = SummaryWriter("runs_60_60")

parser = argparse.ArgumentParser()

parser.add_argument('--obs_len', type=int, default=60)
...
parser.add_argument('--tag', default='bilstmcnn_60_60',
...
def main(args):
    ...
    model = TrajBiLSTMcnn(obs_len=args.obs_len,pred_len=args.pred_len,input_size=args.input_size,hidden_size=args.hidden_size,output_size=args.output_size,
                        num_layers=args.num_layers,kernel_size=args.kernel_size).cuda()
