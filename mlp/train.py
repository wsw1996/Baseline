...
parser.add_argument('--tag', default='linear_60_60',
...
def main(args):
    ...
    model = TrajLinear(obs_len=args.obs_len, pred_len=args.pred_len, hidden_size=args.hidden_size, input_size=args.input_size,
                       output_size=args.output_size).cuda()
