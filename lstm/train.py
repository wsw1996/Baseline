...
parser.add_argument('--tag', default='lstm_60_60', help='personal tag for the model ')
...
def main(args):
    ...
    model = TrajLSTM(obs_len=args.obs_len,pred_len=args.pred_len,input_size=args.input_size,hidden_size=args.hidden_size,output_size=args.output_size,num_layers=args.num_layers).cuda()
